...
namespace FarseerPhysics.Common
{
    ...
    public struct Transform
    {
        ...
        public static Vector2 Divide(ref Vector2 left, ref Transform right)
        {
            ...
            return new Vector2(
                (float)(px * right.q.Real + py * right.q.Imaginary),
                (float)(py * right.q.Real - px * right.q.Imaginary));
        }
        ...
        public static void Divide(Vector2 left, ref Transform right, out Vector2 result)
        {
            ...
            float px = left.X - right.p.X;
            float py = left.Y - right.p.Y;
            result.X = (float)(px * right.q.Real + py * right.q.Imaginary);
            result.Y = (float)(py * right.q.Real - px * right.q.Imaginary);
        }
