    ...
    public class Surface : PhysicsObject
    {
        ...
        private static double GetMinHeightDifference(double[] heights)
        {
            ...
            for (int i = 0; i < n - 1; i++)
            {
                ...
                if (diff > double.Epsilon && diff < minHeightDifference)
        ...
        public static Surface Create(Level level, Direction direction)
        {
            if (direction == Direction.Left)
                return CreateLeft(level);
            if (direction == Direction.Right)
                return CreateRight(level);
            if (direction == Direction.Up)
                return CreateTop(level);
            if (direction == Direction.Down)
                return CreateBottom(level);
        ...
        {
            if (direction == Direction.Left)
                return CreateLeft(level, min, max, points);
            if (direction == Direction.Right)
                return CreateRight(level, min, max, points);
            if (direction == Direction.Up)
                return CreateTop(level, min, max, points);
            if (direction == Direction.Down)
                return CreateBottom(level, min, max, points);
        ...
        {
            if (direction == Direction.Left)
                return CreateLeft(level, min, max, points, maxchange);
            if (direction == Direction.Right)
                return CreateRight(level, min, max, points, maxchange);
            if (direction == Direction.Up)
                return CreateTop(level, min, max, points, maxchange);
            if (direction == Direction.Down)
                return CreateBottom(level, min, max, points, maxchange);
