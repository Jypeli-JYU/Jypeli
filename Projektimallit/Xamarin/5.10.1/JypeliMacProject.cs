...
{	
	...
	public class JypeliProject : MonoDevelop.MonoMac.XamMacProjectBase //DotNetAssemblyProject
	{
	...
	public class JypeliProjectConfiguration : MonoMac.MonoMacProjectConfiguration //DotNetProjectConfiguration
	{
