...
public class Peli : PhysicsGame
{
    ...
    void LisaaKontrollit()
    {
        ...
        Keyboard.Listen( Key.Left, ButtonState.Down, Liikuta, "Liikuta pelaajaa", (Touch)null, pelaaja1, -nopeus );
        Keyboard.Listen( Key.Right, ButtonState.Down, Liikuta, "Liikuta pelaajaa", (Touch)null, pelaaja1, nopeus );
        Keyboard.Listen( Key.Up, ButtonState.Down, Hyppaa, "Hyppää", (Touch)null, pelaaja1, hyppyNopeus );
