...
public class Peli : PhysicsGame
{
    ...
    void LiikutaKosketuksella( Touch kosketus )
    {
        double xzone = Screen.Width / 6;
        PhysicsObject maila = null;

        if ( kosketus.PositionOnScreen.X < -xzone )
        {
            maila = maila1;
        }
        else if ( kosketus.PositionOnScreen.X > xzone )
        {
            maila = maila2;
        }
    ...
    void PysaytaKosketuksella( Touch kosketus )
    {
        if ( kosketus.Tag is PhysicsObject )
        {
            ( kosketus.Tag as PhysicsObject ).Stop();
        }
    }
    ...
    {
        AsetaNopeus( maila1, maila1.Velocity );
        AsetaNopeus( maila2, maila2.Velocity );
        base.Update( time );
    }
}
