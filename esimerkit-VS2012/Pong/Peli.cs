...
public class Pong : PhysicsGame
{
    ...
    {
        if ( pallo != null && pallo.Image != null )
        {
            var matrix = Microsoft.Xna.Framework.Matrix.CreateScale( pallo.Image.Width, pallo.Image.Height, 1 );
            Renderer.DrawImage( pallo.Image, ref matrix, Vector.Diagonal );
            //canvas.DrawImage( pallo.Position, pallo.Image );
        }
